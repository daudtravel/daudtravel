        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-5">
          {galleryConfig.displayImages.map((imageSrc, index) => (
            <PhotoView key={`display-${index}`} src={imageSrc}>
              <div className="relative h-[120px] md:h-[160px] rounded-lg border border-gray-200 overflow-hidden cursor-pointer group shadow-sm hover:shadow-md transition-shadow duration-300">
