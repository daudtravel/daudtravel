...
export function ToursList() {
  ...
  const handleDeleteTour = async (id: string) => {
    try {
      ...
      toast.error(t("tours.deleteFailed"));
    }
  };
    ...
    <div className="w-full max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 py-4 sm:py-6 space-y-4 sm:space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-4">
        ...
        >
          ...
          <span className="text-sm sm:text-base">{t("tours.addTour")}</span>
        </Button>
      </div>
      ...
      {tours.length === 0 && !error ? (
        ...
        <div className="space-y-4">
          <div className="hidden lg:grid grid-cols-12 gap-4 px-6 py-3 bg-gray-50 rounded-lg font-semibold text-xs uppercase tracking-wide text-gray-600 border border-gray-200">
            <div className="col-span-2">{t("tours.colImage")}</div>
            <div className="col-span-4">{t("tours.colName")}</div>
            <div className="col-span-3">{t("tours.colStartLocation")}</div>
                    ...
                    <div className="hidden lg:grid grid-cols-12 gap-4 items-center">
                      <div className="col-span-2 flex flex-col items-center gap-2">
                        <div className="relative h-16 w-16 rounded-xl overflow-hidden bg-gray-100 shadow-sm ring-1 ring-gray-200">
                          {imageUrl ? (
                            <Image
                              src={imageUrl}
                              alt={mainLocalization.name || t("tours.imageAlt")}
                              fill
                      ...
                      <div className="col-span-4">
                        <span className="font-semibold text-sm text-gray-900">
                          {mainLocalization.name || t("common.notSpecified")}
                        </span>
                      </div>
                      ...
                      <div className="col-span-1 flex justify-end gap-2">
                        ...
                        <AlertDialog>
                          ...
                          <AlertDialogContent>
                            <AlertDialogHeader>
                              <AlertDialogTitle>{t("tours.deleteTitle")}</AlertDialogTitle>
                              <AlertDialogDescription>
